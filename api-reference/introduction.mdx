...
<Frame>
  <img src="/images/api-overview.png" alt="Mage API Overview" />
</Frame>
...
<Tip>
**Robust Error Handling**: The Mage API provides detailed error messages to help you quickly identify and resolve issues.
</Tip>
...
<Frame>
  <div style="background: #FFF5F2; padding: 20px; border-radius: 8px; border-left: 4px solid #FF7A00;">
    <h4 style="color: #FF7A00; margin: 0 0 10px 0;">⚡ Fair Usage Policy</h4>
    <p style="margin: 0;">Rate limits ensure optimal performance for all users</p>
  </div>
</Frame>
